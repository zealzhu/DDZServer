...
template< class protocol >
class ProtobufConnection : public Connection< protocol >
{
public:
	ProtobufConnection(DataSocket& p_socket);
...
template< class protocol >
ProtobufConnection<protocol>::ProtobufConnection(DataSocket& p_socket)
	: Connection(p_socket)
{
...
// ------------------------------------------------------------------------
template< class protocol >
void ProtobufConnection<protocol>::Receive()
{
	char buffer[HEADERRSIZE];
	ZeroMemory(buffer, HEADERRSIZE);

	// receive the data
	int bytes = DataSocket::Receive(buffer, HEADERRSIZE);
	...
	// tell the protocol policy object about the received data.
	m_protocol.Translate(*this, buffer);
}
